 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Clayton Parnell");
		  toPrint += p1.toString("cparnell8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Mathew Levine");
		  toPrint += p2.toString("mlevine30");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Morgan");
		  toPrint += p3.toString("mgomez46");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Richa");
                  toPrint += p4.toString("gburdell4");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Grace");
                  toPrint += p5.toString("gmrosek3");
        //Person6 replace P56with your name
        //and gburdell5 with your gt id
        Person6 p6 = new Person6("Wilson");
        toPrint += p5.toString("wpu3");
